...
#define ASSIGN_TYPE( name ) _##name = (name)GetProcAddress((HINSTANCE)MemoryBase::GameAssembly, #name);
...
namespace Dumper
{
	...
	UINT_PTR find_class(const char* class_name, const char* _namespace);
